...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Shirt temp = new Shirt("asdf1", "Aiaia", "Uniqlo", 170000, "M", "Cotton", "Male", "White", "Long-sleeve");
        container.add(temp);
        temp = new Shirt("asdf2", "Aiaia", "Uniqlo", 170000, "M", "Cotton", "Male", "White", "Long-sleeve");
        container.add(temp);
        temp = new Shirt("asdf3", "Aiaia", "Uniqlo", 170000, "M", "Cotton", "Male", "White", "Long-sleeve");
        container.add(temp);
